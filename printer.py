...
def chooseMode() -> str:
    ...
    table.add_column("Command")
    table.add_row(
        "Fight with bot for [bold cyan]snow clean company[/bold cyan]", "company"
    )
...
def youWin() -> str:
    ...
    console.print(
        "Your efforts and strategic thinking have paid off! You’ve defeatead your enemy and achieved victory! "
    )
...
def youLose() -> str:
    ...
    console.print(
        "It’s time to train harder and come back with renewed strength!  ", style="bold"
    )
